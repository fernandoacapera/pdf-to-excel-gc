...
COLUNAS = [
    ...
    'UF Proprietário', 'Data da Inclusão', 'Data da Venda', 'Nome Vendedor', 'CPF/CNPJ Vendedor', 'Endereço Vendedor', 
    'Número Vendedor', 'Complemento Vendedor', 'Bairro Vendedor', 'CEP Vendedor', 'Municipio Vendedor', 'UF Vendedor', 
